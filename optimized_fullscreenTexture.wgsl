...
@group(0) @binding(1) var tint_symbol : sampler;

@group(0) @binding(0) var tint_symbol_1 : texture_2d<f32>;
...
fn tint_symbol_8_inner(tint_symbol_4_3 : vec2f) -> vec4f {
  let x_75 = textureSample(tint_symbol_1, tint_symbol, tint_symbol_4_3);
  return x_75;
}
