...
const x_2458 = vec4f(0.5f, 0.0f, 0.5f, 1.0f);
...
fn tint_symbol_186_inner(tint_symbol_153_3 : vec3u) {
  ...
  if (x_2436) {
    ...
    tint_symbol_162 = x_2458;
    if ((tint_symbol_98.inner.tint_symbol_18.x > 0.5f)) {
      tint_symbol_162 = (x_2458 * x_2449);
    }
    tint_symbol_191 = true;
  }
  let x_2468 = tint_symbol_93.inner;
  let x_2465 = tint_symbol_135(vec3f(), x_2468);
  let x_2471 = tint_symbol_93.inner;
  let x_2469 = tint_symbol_136(x_2358, x_2471);
  let x_2474 = tint_symbol_93.inner.tint_symbol_22;
  let x_2476 = tint_symbol_93.inner.tint_symbol_23;
  let x_2472 = tint_symbol_137(x_2465, x_2469, x_2474, x_2476);
  let x_2477 = (x_2472 > 0.0f);
  x_2482 = x_2477;
  if (x_2477) {
    x_2481 = (x_2472 < tint_symbol_189);
    x_2482 = x_2481;
  }
  if (x_2482) {
    tint_symbol_189 = x_2472;
    let x_2486 = (x_2465 + (x_2469 * x_2472));
    let x_2489 = tint_symbol_93.inner.tint_symbol_22;
    let x_2491 = tint_symbol_93.inner.tint_symbol_23;
    let x_2487 = tint_symbol_149(x_2486, x_2489, x_2491);
    tint_symbol_195 = x_2487;
    let x_2495 = tint_symbol_93.inner.tint_symbol_23;
    let x_2493 = tint_symbol_183(x_2486, x_2495);
    if ((tint_symbol_100.inner.tint_symbol_18.x > 0.5f)) {
      let x_2501 = textureSampleLevel(tint_symbol_99, tint_symbol_97, x_2493, 0.0f);
      let x_2513 = tint_symbol_93.inner.tint_symbol_22;
      let x_2515 = tint_symbol_93.inner.tint_symbol_23;
      let x_2511 = tint_symbol_179(x_2486, x_2513, x_2515);
      tint_symbol_195 = normalize((x_2511 * normalize(((x_2501.xyz * 2.0f) - vec3f(1.0f)))));
    }
    let x_2519 = tint_symbol_195;
    let x_2521 = tint_symbol_93.inner.tint_symbol_21;
    let x_2518 = tint_symbol_70(x_2519, x_2521);
    tint_symbol_190 = normalize(x_2518);
    let x_2525 = tint_symbol_93.inner.tint_symbol_23;
    let x_2523 = tint_symbol_148(x_2486, x_2525);
    tint_symbol_162 = x_2523;
    tint_symbol_191 = true;
  }
  var x_2527 : vec3f;
  var x_2533 : vec3f;
  tint_symbol_210 = vec4f();
  let x_2529 = tint_symbol_89.inner.tint_symbol_21;
  x_2527 = tint_symbol_69(vec3f(), x_2529);
  let x_2532 = tint_symbol_89.inner.tint_symbol_21;
  let x_2530 = tint_symbol_70(x_2358, x_2532);
  x_2533 = normalize(x_2530);
  if (tint_symbol_191) {
    var x_2538 : i32;
    var x_2544 : tint_symbol_122;
    var x_2551 : vec3f;
    var x_2553 : vec3f;
    var x_2555 : vec3f;
    var x_2557 : vec3f;
    var x_2560 : vec4f;
    let x_2540 = tint_symbol_95.inner.tint_symbol_88.x;
    x_2538 = tint_ftoi(x_2540);
    let x_2543 = (x_2527 + (x_2533 * tint_symbol_189));
    let x_2546 = tint_symbol_95.inner.tint_symbol_85;
    let x_2549 = tint_symbol_95.inner.tint_symbol_86;
    x_2544 = tint_symbol_124(x_2546.xyz, x_2549.xyz, x_2543);
    x_2551 = normalize(tint_symbol_190);
    x_2553 = normalize(x_2544.tint_symbol_123);
    x_2555 = normalize((x_2527 - x_2543));
    x_2557 = reflect(-(x_2553), x_2551);
    x_2560 = (tint_symbol_162 * 0.10000000149011611938f);
    if ((x_2538 == 1i)) {
      tint_symbol_210 = (((tint_symbol_161 + ((tint_symbol_162 * x_2544.tint_symbol_84) * max(dot(x_2551, x_2553), 0.0f))) + ((x_2161 * x_2544.tint_symbol_84) * pow(max(dot(x_2555, x_2557), 0.0f), 60.0f))) + x_2560);
    } else {
      if ((x_2538 == 2i)) {
        var x_2585 : f32;
        x_2585 = max(dot(x_2551, x_2553), 0.0f);
        tint_symbol_174_1 = 0.20000000298023223877f;
        if ((x_2585 > 0.80000001192092895508f)) {
        ...
        tint_symbol_210 = ((((tint_symbol_162 * x_2544.tint_symbol_84) * tint_symbol_174_1) + ((x_2161 * x_2544.tint_symbol_84) * step(0.5f, pow(max(dot(x_2555, x_2557), 0.0f), 60.0f)))) + (x_2560 * x_2544.tint_symbol_84));
      } else {
        tint_symbol_210 = ((tint_symbol_161 + ((tint_symbol_162 * x_2544.tint_symbol_84) * max(dot(x_2551, x_2553), 0.0f))) + (x_2560 * x_2544.tint_symbol_84));
      }
    }
  } else {
    if ((tint_symbol_102.inner.tint_symbol_18.x > 0.5f)) {
      tint_symbol_210 = textureSampleLevel(tint_symbol_101, tint_symbol_97, vec2f((0.5f + (atan2(x_2533.z, x_2533.x) / (2.0f * 3.14159274101257324219f))), (0.5f - (asin(x_2533.y) / 3.14159274101257324219f))), 0.0f);
    } else {
      tint_symbol_210 = x_2122;
    }
  }
  let x_2647 = tint_symbol_210;
  textureStore(tint_symbol_91, x_2334, x_2647);
  return;
}

fn tint_symbol_186_1() {
  let x_2651 = tint_symbol_153_2;
  tint_symbol_186_inner(x_2651);
  return;
}
